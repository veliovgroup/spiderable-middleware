...
request.defaultOptions.headers     = { 'User-Agent': 'spiderable-middleware/1.6.0', Accept: '*/*' };
...
module.exports = (function () {
  ...
  Spiderable.prototype.ignoredHeaders = ['age', 'alt-svc', 'cache-status', 'cf-connecting-ip', 'cf-ipcountry', 'cf-cache-status', 'cf-ray', 'cf-request-id', 'cnection', 'cneonction', 'connection', 'content-encoding', 'content-length', 'date', 'etag', 'expect-ct', 'expires', 'keep-alive', 'last-modified', 'link', 'nncoection', 'pragma', 'server', 'set-cookie', 'status', 'transfer-encoding', 'vary', 'via', 'www-authenticate', 'x-accel-buffering', 'x-accel-charset', 'x-accel-expires', 'x-accel-limit-rate', 'x-accel-redirect', 'x-ostrio-domain', 'x-powered-by', 'x-preprender-status', 'x-prerender-status', 'x-real-ip', 'x-runtime'];
  ...
  Spiderable.prototype.middleware = function (req, res, next) {
    ...
    if (urlObj.query._escaped_fragment_ !== void 0 || this.botsRE.test(req.headers[strs.ua] || strs.empty)) {
